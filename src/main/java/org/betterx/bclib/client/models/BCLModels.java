...
public class BCLModels {
    ...
    public static final Identifier BAR_STOOL_MODEL_LOCATION = BCLib.C.mk(
        "block/bar_stool"
    );
    ...
    public static final Identifier CHAIR_MODEL_LOCATION = BCLib.C.mk(
        "block/chair"
    );
    ...
    public static final Identifier TABURET_MODEL_LOCATION = BCLib.C.mk(
        "block/taburet"
    );
    ...
    public static final Identifier CHEST_MODEL_LOCATION = BCLib.C.mk(
        "block/chest_item"
    );
    ...
    public static final Identifier PATH_MODEL_LOCATION = BCLib.C.mk(
        "block/path"
    );
    ...
    public static final Identifier LADDER_MODEL_LOCATION = BCLib.C.mk(
        "block/ladder"
    );
    ...
    public static void createBarStoolBlockModel(
        ...
        Identifier modelLocation = BAR_STOOL.create(
            block,
            mapping,
            generators.vanillaGenerator.modelOutput
        );

        var blockStateGenerator = MultiVariantGenerator.dispatch(block).with(
            getChairFacingPropertyDispatch(modelLocation)
        );
    ...
    public static void createTaburetBlockModel(
        ...
        Identifier modelLocation = TABURET.create(
            block,
            mapping,
            generators.vanillaGenerator.modelOutput
        );
    ...
    public static void createChairBlockModel(
        ...
        Identifier modelLocation = CHAIR.create(
            block,
            mapping,
            generators.vanillaGenerator.modelOutput
        );
        ...
        var blockStateGenerator = MultiVariantGenerator.dispatch(block).with(
            PropertyDispatch.initial(FACING, BaseChair.TOP)
    ...
    private static PropertyDispatch.@NotNull C1<
        MultiVariant,
        Direction
    > getChairFacingPropertyDispatch(Identifier modelLocation) {
        var modelVariant = plainVariant(modelLocation);
        return PropertyDispatch.initial(FACING)
