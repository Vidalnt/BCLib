...
public class BCLibClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        AtlasSetManager.addSource(
            AtlasSetManager.VANILLA_BLOCKS,
            new DirectoryLister("entity/chest", "entity/chest/")
        );
        AtlasSetManager.addSource(
            AtlasSetManager.VANILLA_BLOCKS,
            new DirectoryLister("blocks", "blocks/")
        );
    }

    private static void onInitializeModelLoader(
    ...
    /// /        if (ctx.id() instanceof Identifier modelId && modelId.getVariant().equals("inventory")) {
    /// /            isItem = true;
    /// /        }
    //
