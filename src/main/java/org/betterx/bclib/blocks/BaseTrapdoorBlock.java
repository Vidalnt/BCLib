        ...
        DropSelfLootProvider<BaseTrapdoorBlock>
{
    ...
    private VariantProperties.Rotation xRotationForState(
        boolean isTop,
        boolean isOpen,
        Direction dir
    ) {
    ...
    private VariantProperties.Rotation yRotationForState(
        boolean isTop,
        boolean isOpen,
        Direction dir
    ) {
    ...
    public void provideBlockModels(WoverBlockModelGenerators generator) {
        ...
        generator.acceptBlockState(
            MultiVariantGenerator.multiVariant(this).with(props)
        );
    }
