        ...
        ItemTagProvider
{
    ...
    public static TextureMapping craftingTableTextureMapping(
        Block block,
        Block block2
    ) {
        return (new TextureMapping()).put(
            ...
            .put(
                TextureSlot.DOWN,
                TextureMapping.getBlockTexture(block2, "_bottom")
            )
    ...
    public void provideBlockModels(WoverBlockModelGenerators generator) {
        generator.vanillaGenerator.createCraftingTableLike(
            this,
            this,
            BaseCraftingTableBlock::craftingTableTextureMapping
        );
    }
    ...
    public void registerBlockTags(
        ...
        context.add(
            org.betterx.wover.tag.api.predefined.CommonBlockTags.WORKBENCHES,
            this
        );
    }
    ...
    public void registerItemTags(
        ...
        context.add(
            this,
            org.betterx.wover.tag.api.predefined.CommonItemTags.WORKBENCHES
        );
    }
