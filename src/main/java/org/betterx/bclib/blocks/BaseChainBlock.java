...
public abstract class BaseChainBlock
    extends ChainBlock
    implements
        BlockModelProvider,
        RenderLayerProvider,
        DropSelfLootProvider<BaseChainBlock>
{
    ...
    public void provideBlockModels(WoverBlockModelGenerators generator) {
        generator.vanillaGenerator.createAxisAlignedPillarBlockCustomModel(
            this,
            generator.vanillaGenerator.plainVariant(
    ...
    //        Identifier modelId = RuntimeBlockModelProvider.remapIdentifier(stateId, blockState);
