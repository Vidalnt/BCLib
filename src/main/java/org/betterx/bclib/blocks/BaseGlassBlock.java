...
public class BaseGlassBlock
    extends BaseBlockNotFull
    implements AddMineablePickaxe, RenderLayerProvider, BlockLootProvider
{
    ...
    public boolean skipRendering(
        ...
        return (
            ...
            super.skipRendering(state, neighbor, facing)
        );
    }
