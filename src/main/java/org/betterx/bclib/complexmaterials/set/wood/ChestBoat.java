...
public class ChestBoat extends SimpleMaterialSlot<WoodenComplexMaterial> {
    ...
    @Override
    public void addBlockEntry(
        WoodenComplexMaterial parentMaterial,
        Consumer<BlockEntry> adder
    ) {}
    ...
    @Override
    protected @Nullable ItemEntry getItemEntry(
        WoodenComplexMaterial parentMaterial
    ) {
        return new ItemEntry(suffix, (cmx, settings) ->
            parentMaterial.getBoatType().createItem(true)
    ...
    public static void makeChestBoatRecipe(
        RecipeOutput context,
        Identifier id,
        Item boat,
        Item chestBoat
    ) {
        CraftingRecipeBuilder craftingRecipeBuilder = RecipeBuilder.crafting(
            id,
            chestBoat
        )
            .shapeless()
        ...
        > craftingRecipeBuilderBaseRecipeBuilder = craftingRecipeBuilder.group(
            "chest_boat"
        );
        craftingRecipeBuilderBaseRecipeBuilder
