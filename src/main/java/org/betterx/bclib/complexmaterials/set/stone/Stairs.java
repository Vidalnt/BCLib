...
public class Stairs extends AbstractStairs<StoneComplexMaterial> {
    ...
    protected @NotNull Block createBlock(
        ...
        return new BaseStairsBlock.Stone(
            parentMaterial.getBlock(getSourceBlockSlot())
        );
    }
    ...
    protected @Nullable void makeRecipe(
        ...
        RecipeBuilder.stonecutting(
            Identifier.fromNamespaceAndPath(
                id.getNamespace(),
                "stonecutter_" + id.getPath()
            ),
    ...
    @Override
    protected @Nullable MaterialSlot<
        StoneComplexMaterial
    > getSourceBlockSlot() {
        return base;
    }
}
