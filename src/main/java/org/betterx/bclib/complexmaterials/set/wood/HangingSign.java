...
public class HangingSign extends MaterialSlot<WoodenComplexMaterial> {
    ...
    public void addBlockEntry(
        ...
        var signEntry = new BlockEntry(suffix, (complexMaterial, settings) ->
            new BaseHangingSignBlock.Wood(
                parentMaterial.getBlock(WoodSlots.PLANKS),
                parentMaterial.woodType
            )
        );
        ...
        var wallSignEntry = new BlockEntry(
            ...
            (complexMaterial, settings) -> {
                if (
                    complexMaterial.getBlock(suffix) instanceof
                        BaseHangingSignBlock sign
                ) {
    ...
    public void addRecipeEntry(
        ...
        adder.accept(
            new RecipeEntry(suffix, (ctx, mat, id) ->
