...
public class IdConfig extends Config {
    ...
    public IdConfig(
        String modID,
        String group,
        BiFunction<Identifier, String, ConfigKey> keyFactory
    ) {
        super(modID, group);
    ...
    @Nullable
    public <T, E extends ConfigKeeper.Entry<T>> E getEntry(
        Identifier id,
        String key,
        Class<E> type
    ) {
    ...
    @Nullable
    public <T, E extends ConfigKeeper.Entry<T>> T getDefault(
        Identifier id,
        String key,
        Class<E> type
    ) {
    ...
    public boolean setRangedInt(Identifier id, String key, int value) {
        return this.setRanged(
            createKey(id, key),
            value,
            ConfigKeeper.IntegerRange.class
        );
    }
