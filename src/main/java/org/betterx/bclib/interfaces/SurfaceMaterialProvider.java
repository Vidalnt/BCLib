...
public interface SurfaceMaterialProvider {
    MapCodec<SurfaceMaterialProvider> CODEC = RecordCodecBuilder.mapCodec(
        instance ->
            instance
                .group(
                    BlockState.CODEC.fieldOf("top").forGetter(
                        SurfaceMaterialProvider::getTopMaterial
                    ),
                    BlockState.CODEC.fieldOf("under").forGetter(
                        SurfaceMaterialProvider::getUnderMaterial
                    ),
                    BlockState.CODEC.fieldOf("alt").forGetter(
                        SurfaceMaterialProvider::getAltTopMaterial
                    ),
                    Codec.BOOL.fieldOf("floor_rule").forGetter(
                        SurfaceMaterialProvider::generateFloorRule
                    )
                )
    ...
    default void addBiomeSurfaceToEndGroup(
    ...
    static Optional<SurfaceMaterialProvider> findSurfaceMaterialProvider(
        WorldGenLevel world,
        BlockPos pos
    ) {
    ...
    static Optional<SurfaceMaterialProvider> findSurfaceMaterialProvider(
        ...
        if (biome != null) {
            BiomeData data = WorldState.registryAccess()
